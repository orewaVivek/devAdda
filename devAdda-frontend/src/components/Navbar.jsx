      ...
      >
        ...
        <div className="flex gap-2">
          ...
          {user && (
            <div>
              <button
                className="border p-2 rounded-xl cursor-pointer hover:bg-white hover:text-black transition-colors duration-200 mx-4"
                onClick={() => navigate("/connections")}
              >
                Connections
              </button>
              <button
                className="border p-2 rounded-xl cursor-pointer hover:bg-white hover:text-black transition-colors duration-200"
